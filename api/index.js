// Используем тот же код, что и в webhook.js
...
// Для отладки
console.log('Main API handler initialized');
  ...
  try {
    ...
    if (req.method === 'GET') {
      return res.status(200).json({
        ...
        message: 'Main API endpoint for Sunset house Telegram bot',
        info: 'This endpoint handles all webhook requests from Telegram'
      });
    }
